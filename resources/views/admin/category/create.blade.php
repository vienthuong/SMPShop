                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" class="form-control border-input" placeholder="Category name" value="{{ old('name') }}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="desc" rows="4" class="form-control border-input" placeholder="Category Description">{{ old('desc') }}</textarea>
                                            </div>
                                        </div>
                                    </div>
